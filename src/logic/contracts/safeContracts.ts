...
const getGnosisSafeContractInstance = (web3: Web3, chainId: ChainId): GnosisSafe => {
  ...
  if (!contractAddress) {
    contractAddress = safeSingletonDeployment?.networkAddresses['4']
  }
  if (!contractAddress) {
...
const getProxyFactoryContractInstance = (web3: Web3, chainId: ChainId): ProxyFactory => {
  ...
  if (!contractAddress) {
    contractAddress = proxyFactoryDeployment?.networkAddresses['4']
  }
  if (!contractAddress) {
...
const getFallbackHandlerContractInstance = (web3: Web3, chainId: ChainId): CompatibilityFallbackHandler => {
  ...
  if (!contractAddress) {
    contractAddress = fallbackHandlerDeployment?.networkAddresses['4']
  }
  if (!contractAddress) {
...
const getMultiSendContractInstance = (web3: Web3, chainId: ChainId): MultiSend => {
  ...
  if (!contractAddress) {
    contractAddress = multiSendDeployment?.networkAddresses['4']
  }
  if (!contractAddress) {
...
export const getSignMessageLibAddress = (chainId: ChainId): string | undefined => {
  ...
  if (!contractAddress) {
    contractAddress = signMessageLibDeployment?.networkAddresses['4']
  }
  if (!contractAddress) {
